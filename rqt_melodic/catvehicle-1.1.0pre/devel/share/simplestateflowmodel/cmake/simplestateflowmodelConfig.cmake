...
if("TRUE" STREQUAL "TRUE")
  set(simplestateflowmodel_SOURCE_PREFIX /home/catvehicle-1.1.0pre/src/simplestateflowmodel)
  set(simplestateflowmodel_DEVEL_PREFIX /home/catvehicle-1.1.0pre/devel)
  ...
  set(simplestateflowmodel_INSTALL_PREFIX /home/catvehicle-1.1.0pre/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simplestateflowmodel' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'simplestateflowmodel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/catvehicle-1.1.0pre/src/simplestateflowmodel/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT simplestateflowmodel_NUM_DUMMY_TARGETS)
      set(simplestateflowmodel_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::simplestateflowmodel::wrapped-linker-option${simplestateflowmodel_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR simplestateflowmodel_NUM_DUMMY_TARGETS "${simplestateflowmodel_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::simplestateflowmodel::wrapped-linker-option${simplestateflowmodel_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND simplestateflowmodel_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${simplestateflowmodel_dep}_FOUND)
      find_package(${simplestateflowmodel_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${simplestateflowmodel_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
